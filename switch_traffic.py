...
def main(net):
    ...
    def traffic_update_and_add(ethaddr, input_port, accessed, max_entries=5):
        ...
        forwarding_table[ethaddr] = (input_port, accessed)
    ...
    while True:
        ...
        if packet[0].src not in forwarding_table:
            traffic_update_and_add(packet[0].src, input_port, 1)
        ...
        if packet[0].dst in mymacs:
            ...
            if packet[0].dst in forwarding_table:
                ...
                forwarding_table[packet[0].dst] = (
                    forwarding_table[packet[0].dst][0], 
                    forwarding_table[packet[0].dst][1] + 1
                )
